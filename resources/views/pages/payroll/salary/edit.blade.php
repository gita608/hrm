...
@section('title', 'Modify Compensation')
...
<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-4">
    <div class="my-auto">
        <h2 class="mb-1 text-dark fw-bold">Modify Compensation</h2>
        <p class="text-muted mb-0 fs-13">Amdending the financial structure for <strong>{{ $salary->employee->name ?? 'Staff' }}</strong></p>
    </div>
                ...
                <div class="card-body p-4 p-md-5">
                        ...
                        <div class="row g-3 ms-md-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group finance-input-group border-0">
                                    ...
                                    <input type="number" step="0.01" class="form-control bg-transparent border-0 shadow-none fw-bold @error('basic_salary') is-invalid @enderror" name="basic_salary" id="basic_salary" value="{{ old('basic_salary', $salary->basic_salary) }}" placeholder="0.00" required>
                                </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row g-3 ms-md-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" class="form-control finance-input-group border-0" name="housing_allowance" id="housing_allowance" value="{{ old('housing_allowance', $salary->housing_allowance) }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fs-11 fw-bold text-muted">Transport</label>
                                <input type="number" step="0.01" class="form-control finance-input-group border-0" name="transport_allowance" id="transport_allowance" value="{{ old('transport_allowance', $salary->transport_allowance) }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fs-11 fw-bold text-muted">Food / Utility</label>
                                <input type="number" step="0.01" class="form-control finance-input-group border-0" name="food_allowance" id="food_allowance" value="{{ old('food_allowance', $salary->food_allowance) }}">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fs-11 fw-bold text-muted">Other Perks</label>
                                <input type="number" step="0.01" class="form-control finance-input-group border-0" name="other_allowances" id="other_allowances" value="{{ old('other_allowances', $salary->other_allowances) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row g-3 ms-md-4">
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.01" class="form-control finance-input-group border-0 text-danger" name="tax_deduction" id="tax_deduction" value="{{ old('tax_deduction', $salary->tax_deduction) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fs-11 fw-bold text-muted">Provident Fund</label>
                                <input type="number" step="0.01" class="form-control finance-input-group border-0 text-danger" name="provident_fund" id="provident_fund" value="{{ old('provident_fund', $salary->provident_fund) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fs-11 fw-bold text-muted">Misc. Deductions</label>
                                <input type="number" step="0.01" class="form-control finance-input-group border-0 text-danger" name="other_deductions" id="other_deductions" value="{{ old('other_deductions', $salary->other_deductions) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control finance-input-group border-0" name="effective_from" value="{{ old('effective_from', $salary->effective_from->format('Y-m-d')) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select finance-input-group border-0" name="status" required>
                                <option value="active" {{ $salary->status == 'active' ? 'selected' : '' }}>Regular Assignment (Active)</option>
                                <option value="inactive" {{ $salary->status == 'inactive' ? 'selected' : '' }}>Archived Package (Inactive)</option>
                            </select>
                        </div>
                    </div>

                    <div class="mt-5 d-flex gap-2">
                        <button type="submit" class="btn btn-info rounded-pill px-5 py-3 fw-bold text-white shadow-lg">Apply Amendments</button>
                    </div>
        ...
        <div class="col-xl-4">
            <div class="summary-widget shadow-lg">
                ...
                <div class="mt-4 p-3 bg-white-transparent rounded-4 fs-11 opacity-75">
                    <i class="ti ti-info-circle me-1"></i> These updates will reflect from the specified effective date. Historical payslips will remain unchanged.
                </div>
            </div>
        </div>
    </div>
