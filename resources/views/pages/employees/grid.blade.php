					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{ url("/employees/details") }}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
										<img src="{{ asset("assets/img/users/") }}user-32.jpg" class="img-fluid h-auto w-auto" alt="img">
									</a>
								</div>
								<div class="dropdown">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Anthony Lewis</a></h6>
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{ url("/employees/details") }}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
										<img src="{{ asset("assets/img/users/") }}user-09.jpg" class="img-fluid h-auto w-auto" alt="img">
									</a>
								</div>
								<div class="dropdown">
									<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Brian Villalobos</a></h6>
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{ url("/employees/details") }}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
										<img src="{{ asset("assets/img/users/") }}user-01.jpg" class="img-fluid h-auto w-auto" alt="img">
									</a>
								</div>
								<div class="dropdown">
									<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Harvey Smith</a></h6>
								<span class="badge badge-purple-transparent fs-10 fw-medium">Developer</span>
							</div>
							<div class="row text-center">
								<div class="col-4">
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Stephan Peralt</a></h6>
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{ url("/employees/details") }}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
										<img src="{{ asset("assets/img/users/") }}user-34.jpg" class="img-fluid h-auto w-auto" alt="img">
									</a>
								</div>
								<div class="dropdown">
									<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Doglas Martini</a></h6>
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Linda Ray</a></h6>
								<span class="badge bg-pink-transparent fs-10 fw-medium">Software Developer</span>
							</div>
							<div class="row text-center">
								<div class="col-4">
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Elliot Murray</a></h6>
								<span class="badge badge-purple-transparent fs-10 fw-medium">Developer</span>
							</div>
							<div class="row text-center">
								<div class="col-4">
					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex justify-content-between align-items-start mb-2">
								...
								<div>
									<a href="{{ url("/employees/details") }}" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
										<img src="{{ asset("assets/img/users/user-37.jpg") }}" class="img-fluid h-auto w-auto" alt="img">
									</a>
								</div>
								<div class="dropdown">
									<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Rebecca Smtih</a></h6>
				...
				<div class="col-xl-3 col-lg-4 col-md-6">
					<div class="card">
						<div class="card-body">
							...
							<div class="text-center mb-3">
								<h6 class="mb-1"><a href="{{ url("/employees/details") }}">Connie Waters</a></h6>
								<span class="badge bg-pink-transparent fs-10 fw-medium">Software Developer</span>
							</div>
							<div class="row text-center">
								<div class="col-4">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-start mb-2">
									...
									<div>
										<a href="https://smarthr.co.in/demo/html/template/employee-details.html" class="avatar avatar-xl avatar-rounded online border p-1 border-primary rounded-circle">
											<img src="{{ asset("assets/img/users/") }}user-38.jpg" class="img-fluid h-auto w-auto" alt="img">
										</a>
									</div>
									<div class="dropdown">
										<button class="btn btn-icon btn-sm rounded-circle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="https://smarthr.co.in/demo/html/template/employee-details.html">Lori Broaddus</a></h6>
									<span class="badge badge-secondary-transparent fs-10 fw-medium">Full Stack Developer</span>
								</div>
								<div class="row text-center">
									<div class="col-4">
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="https://smarthr.co.in/demo/html/template/employee-details.html">Trent Frazier</a></h6>
									<span class="badge bg-pink-transparent fs-10 fw-medium">Software Developer</span>
								</div>
								<div class="row text-center">
									<div class="col-4">
					...
					<div class="col-xl-3 col-lg-4 col-md-6">
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mb-3">
									<h6 class="mb-1"><a href="https://smarthr.co.in/demo/html/template/employee-details.html">Norene Valle</a></h6>
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="{{ url("/employees/grid") }}" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
