		...
		<div class="card-body p-4">
			<form action="{{ route('employees.update', $employee->id) }}" method="POST" enctype="multipart/form-data">
				...
				<div class="row">
							...
							<div class="d-flex align-items-center flex-wrap row-gap-3 bg-light-50 border border-light w-100 rounded-4 p-4">
								<div class="d-flex align-items-center justify-content-center avatar avatar-xxl rounded-circle border border-2 border-white shadow-sm me-3 flex-shrink-0 text-dark bg-white overflow-hidden" id="profile-preview-container" style="width: 100px; height: 100px;">
									@if($employee->profile_picture)
										<img id="profile-preview" src="{{ asset('storage/' . $employee->profile_picture) }}" alt="Profile Preview" class="img-fluid rounded-circle" style="width: 100%; height: 100%; object-fit: cover;">
										<i class="ti ti-photo text-muted fs-30 d-none" id="profile-preview-icon"></i>
									@else
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="name" value="{{ old('name', $employee->name) }}" placeholder="Enter full name" required>
							@error('name')
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="email" class="form-control rounded-3 border-light shadow-none" name="email" value="{{ old('email', $employee->email) }}" placeholder="Enter email address" required>
							@error('email')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label text-muted fs-12 text-uppercase fw-medium">Password</label>
							<div class="pass-group position-relative">
								<input type="password" class="pass-input form-control rounded-3 border-light shadow-none" name="password" placeholder="Leave blank to keep current password">
							...
							<small class="text-muted fs-11 mt-1 d-block">Leave blank if you don't want to change the password</small>
							@error('password')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label text-muted fs-12 text-uppercase fw-medium">Confirm Password</label>
							<div class="pass-group position-relative">
								<input type="password" class="pass-input form-control rounded-3 border-light shadow-none" name="password_confirmation" placeholder="Confirm new password">
								<span class="ti toggle-password ti-eye-off position-absolute end-0 top-50 translate-middle-y me-3 cursor-pointer text-muted"></span>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="phone" value="{{ old('phone', $employee->phone) }}" placeholder="Enter phone number">
							@error('phone')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-12">
						<div class="mb-3">
							...
							<textarea class="form-control rounded-3 border-light shadow-none" name="address" rows="3" placeholder="Enter address">{{ old('address', $employee->address) }}</textarea>
							@error('address')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="emirates_id" value="{{ old('emirates_id', $employee->emirates_id) }}" placeholder="e.g., 784-1234-1234567-1">
							@error('emirates_id')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="nationality" value="{{ old('nationality', $employee->nationality) }}" placeholder="Enter nationality">
							@error('nationality')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="passport_number" value="{{ old('passport_number', $employee->passport_number) }}" placeholder="Enter passport number">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control rounded-3 border-light shadow-none" name="passport_expiry_date" value="{{ old('passport_expiry_date', $employee->passport_expiry_date?->format('Y-m-d')) }}">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<select class="form-select rounded-3 border-light shadow-none" name="visa_type">
								...
								<option value="student" {{ old('visa_type', $employee->visa_type) == 'student' ? 'selected' : '' }}>Student</option>
								<option value="tourist" {{ old('visa_type', $employee->visa_type) == 'tourist' ? 'selected' : '' }}>Tourist</option>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="visa_number" value="{{ old('visa_number', $employee->visa_number) }}" placeholder="Enter visa number">
							@error('visa_number')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control rounded-3 border-light shadow-none" name="visa_expiry_date" value="{{ old('visa_expiry_date', $employee->visa_expiry_date?->format('Y-m-d')) }}">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="labor_card_number" value="{{ old('labor_card_number', $employee->labor_card_number) }}" placeholder="Enter labor card number">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control rounded-3 border-light shadow-none" name="labor_card_expiry_date" value="{{ old('labor_card_expiry_date', $employee->labor_card_expiry_date?->format('Y-m-d')) }}">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="uae_city" value="{{ old('uae_city', $employee->uae_city) }}" placeholder="Enter city">
							@error('uae_city')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="uae_area" value="{{ old('uae_area', $employee->uae_area) }}" placeholder="Enter area">
							@error('uae_area')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="bank_name" value="{{ old('bank_name', $employee->bank_name) }}" placeholder="e.g., Emirates NBD, ADCB">
							@error('bank_name')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="iban" value="{{ old('iban', $employee->iban) }}" placeholder="AE123456789012345678901">
							@error('iban')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="emergency_contact_name" value="{{ old('emergency_contact_name', $employee->emergency_contact_name) }}" placeholder="Enter emergency contact name">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none" name="emergency_contact_phone" value="{{ old('emergency_contact_phone', $employee->emergency_contact_phone) }}" placeholder="Enter emergency contact phone">
				...
				<div class="d-flex justify-content-end gap-2 mt-4">
					...
					<button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm">Update Employee</button>
				</div>
			</form>
		</div>
	</div>
