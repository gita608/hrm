...
@section('content')
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
		...
		<div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
			<div class="mb-2">
				<a href="{{ route('departments.create') }}" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Add Department</a>
			</div>
				...
				<div class="card-body d-flex align-items-center justify-content-between">
					<div class="d-flex align-items-center overflow-hidden">
						...
						<div class="ms-2 overflow-hidden">
							<p class="fs-12 fw-medium mb-1 text-truncate">Total Departments</p>
				...
				<div class="card-body d-flex align-items-center justify-content-between">
					<div class="d-flex align-items-center overflow-hidden">
						...
						<div class="ms-2 overflow-hidden">
							...
							<h4>{{ $departments->where('is_active', true)->count() }}</h4>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card-body d-flex align-items-center justify-content-between">
					<div class="d-flex align-items-center overflow-hidden">
						...
						<div class="ms-2 overflow-hidden">
							...
							<h4>{{ $departments->where('is_active', false)->count() }}</h4>
						</div>
					</div>
				</div>
			</div>
							...
							<tr>
								...
								<td>
									<div class="action-icon d-inline-flex">
										<a href="{{ route('departments.edit', $department->id) }}" class="me-2" data-bs-toggle="tooltip" title="Edit"><i class="ti ti-edit"></i></a>
