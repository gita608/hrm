...
@section('content')
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
		<div class="my-auto mb-2">
			<h2 class="mb-1">Schedule Interview</h2>
		</div>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control @error('job_title') is-invalid @enderror" name="job_title" value="{{ old('job_title') }}" placeholder="e.g., Software Developer">
							@error('job_title')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							<input type="text" class="form-control @error('candidate_name') is-invalid @enderror" name="candidate_name" value="{{ old('candidate_name') }}" id="candidate_name">
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							<input type="email" class="form-control @error('candidate_email') is-invalid @enderror" name="candidate_email" value="{{ old('candidate_email') }}" id="candidate_email">
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							<input type="text" class="form-control @error('candidate_phone') is-invalid @enderror" name="candidate_phone" value="{{ old('candidate_phone') }}" id="candidate_phone">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control @error('interview_date') is-invalid @enderror" name="interview_date" value="{{ old('interview_date') }}" required>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="time" class="form-control @error('interview_time') is-invalid @enderror" name="interview_time" value="{{ old('interview_time') }}" required>
					...
					<div class="col-md-12">
						<div class="mb-3">
							...
							<input type="text" class="form-control @error('location') is-invalid @enderror" name="location" value="{{ old('location') }}" placeholder="Physical location or video call link">
							@error('location')
								<div class="invalid-feedback">{{ $message }}</div>
							@enderror
						</div>
