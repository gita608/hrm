...
@section('content')
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-4">
		<div class="my-auto">
			<h2 class="mb-1 text-dark fw-bold">Edit Interview</h2>
			<p class="text-muted mb-0 fs-13">Update interview schedule and details</p>
		</div>
		...
		<div class="card-body p-4">
			<form action="{{ route('interviews.update', $interview->id) }}" method="POST">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none @error('job_title') is-invalid @enderror" name="job_title" value="{{ old('job_title', $interview->job_title) }}" placeholder="e.g., Software Developer">
							@error('job_title')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none @error('candidate_name') is-invalid @enderror" name="candidate_name" value="{{ old('candidate_name', $interview->candidate_name) }}" id="candidate_name">
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							<input type="email" class="form-control rounded-3 border-light shadow-none @error('candidate_email') is-invalid @enderror" name="candidate_email" value="{{ old('candidate_email', $interview->candidate_email) }}" id="candidate_email">
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none @error('candidate_phone') is-invalid @enderror" name="candidate_phone" value="{{ old('candidate_phone', $interview->candidate_phone) }}" id="candidate_phone">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control rounded-3 border-light shadow-none @error('interview_date') is-invalid @enderror" name="interview_date" value="{{ old('interview_date', $interview->interview_date->format('Y-m-d')) }}" required>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="time" class="form-control rounded-3 border-light shadow-none @error('interview_time') is-invalid @enderror" name="interview_time" value="{{ old('interview_time', \Carbon\Carbon::parse($interview->interview_time)->format('H:i')) }}" required>
					...
					<div class="col-md-12">
						<div class="mb-3">
							...
							<input type="text" class="form-control rounded-3 border-light shadow-none @error('location') is-invalid @enderror" name="location" value="{{ old('location', $interview->location) }}" placeholder="Physical location or video call link">
							@error('location')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-12">
						<div class="mb-3">
							...
							<textarea class="form-control rounded-3 border-light shadow-none @error('description') is-invalid @enderror" name="description" rows="3">{{ old('description', $interview->description) }}</textarea>
							@error('description')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-12">
						<div class="mb-3">
							...
							<textarea class="form-control rounded-3 border-light shadow-none @error('notes') is-invalid @enderror" name="notes" rows="2">{{ old('notes', $interview->notes) }}</textarea>
							@error('notes')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
				...
				<div class="d-flex justify-content-end gap-2 mt-4">
					...
					<button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm">Update Interview</button>
				</div>
			</form>
		</div>
	</div>
