...
@section('content')
	...
	<div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-4">
		<div class="my-auto">
			<h2 class="mb-1 text-dark fw-bold">Create Training</h2>
			<p class="text-muted mb-0 fs-13">Schedule a new training session for employees</p>
		</div>
		...
		<div class="card-body p-4">
			<form action="{{ route('training.store') }}" method="POST">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="date" class="form-control rounded-3 border-light shadow-none" name="end_date" value="{{ old('end_date') }}" required>
							@error('end_date')
								<div class="invalid-feedback d-block">{{ $message }}</div>
							@enderror
						</div>
					...
					<div class="col-md-6">
						<div class="mb-3">
							...
							<input type="number" class="form-control rounded-3 border-light shadow-none" name="max_participants" value="{{ old('max_participants') }}" min="1">
				...
				<div class="d-flex justify-content-end gap-2 mt-4">
					...
					<button type="submit" class="btn btn-primary rounded-pill px-4 shadow-sm">Save Training</button>
				</div>
			</form>
		</div>
	</div>
