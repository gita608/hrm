		...
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li>
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class="{{ request()->is('/') || request()->is('dashboard*') ? 'active subdrop' : '' }}">
							...
							<ul>
								<li><a href="{{ url('/') }}" class="{{ request()->is('/') ? 'active' : '' }}">Admin Dashboard</a></li>
						...
						<li class="submenu">
							...
							<ul>
								...
								<li class="submenu submenu-two">
									<a href="{{ url('/calls') }}">Calls<span class="menu-arrow inside-submenu"></span></a>
									<ul>
										...
										<li><a href="{{ url('/call-history') }}">Call History</a></li>
									</ul>
								</li>
								...
								<li><a href="{{ url('/social-feed') }}">Social Feed</a></li>
								<li><a href="{{ url('/file-manager') }}">File Manager</a></li>
						...
						<li class="submenu">
							...
							<ul>
								...
								<li><a href="{{ url('/super-admin/companies') }}">Companies</a></li>
								<li><a href="{{ url('/super-admin/subscriptions') }}">Subscriptions</a></li>
								<li><a href="{{ url('/super-admin/packages') }}">Packages</a></li>
								<li><a href="{{ url('/super-admin/domain') }}">Domain</a></li>
								<li><a href="{{ url('/super-admin/transactions') }}">Purchase Transaction</a></li>
							</ul>
						</li>
					</ul>
				</li>
